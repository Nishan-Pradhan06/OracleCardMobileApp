...
part '../bloc/get_journal_by_id_bloc.freezed.dart';

class GetJournalByIdBloc extends Bloc<GetJournalByIdEvent, GetJournalByIdState> {
  GetJournalByIdBloc() : super(_Initial()) {
