...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _GetUserProfileEvent value)?  getUserProfile,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GetUserProfileEvent() when getUserProfile != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _GetUserProfileEvent value)  getUserProfile,}){
final _that = this;
switch (_that) {
case _GetUserProfileEvent():
return getUserProfile(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _GetUserProfileEvent value)?  getUserProfile,}){
final _that = this;
switch (_that) {
case _GetUserProfileEvent() when getUserProfile != null:
return getUserProfile(_that);case _:
...
class _GetUserProfileEvent implements UserProfileEvent {
  const _GetUserProfileEvent();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GetUserProfileEvent);
}
